// XState v4 truth runner for the withconfig_basic scenario.
// Usage: `node projects/xstate-v4-truth/runner/run_withconfig_basic.js`
'use strict';
...
function runScenario() {
  ...
  var baseMachine = createMachine(mappedConfig, {
    actions: {
      logGo: function () {}
    },
    guards: {
