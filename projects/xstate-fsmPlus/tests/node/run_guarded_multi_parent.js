// FSMPlus Node harness for the guarded_multi_parent scenario.
// Usage: `node projects/xstate-fsmPlus/tests/node/run_guarded_multi_parent.js`
'use strict';

var fsm = require('../../src/xstate_fsmPlus');
var machineConfig = require('../../../../examples/guarded-multi-parent/guarded_multi_parent.machine');
var events = require('../../../../examples/guarded-multi-parent/guarded_multi_parent.events');
var expected = require('../../../../examples/guarded-multi-parent/guarded_multi_parent.expected');
var fs = require('fs');
...
function runScenario() {
  ...
  var resultsPath = path.join(resultsDir, 'guarded_multi_parent.trace.txt');
  try {
