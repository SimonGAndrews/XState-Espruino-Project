// FSMPlus Node harness for the withconfig_basic scenario.
// Usage: `node projects/xstate-fsmPlus/tests/node/run_withconfig_basic.js`
'use strict';

var fsm = require('../../src/xstate_fsmPlus');
var machineConfig = require('../../../../examples/withconfig-basic/withconfig_basic.machine');
var events = require('../../../../examples/withconfig-basic/withconfig_basic.events');
var expected = require('../../../../examples/withconfig-basic/withconfig_basic.expected');
var fs = require('fs');
...
function runScenario() {
  var baseMachine = fsm.createMachine(machineConfig);
  var machine = baseMachine.withConfig({
    guards: {
      allow: function (ctx) { return ctx.count === 5; }
    },
    actions: {
      logGo: function () {}
    }
  ...
  var resultsPath = path.join(resultsDir, 'withconfig_basic.trace.txt');
  try {
