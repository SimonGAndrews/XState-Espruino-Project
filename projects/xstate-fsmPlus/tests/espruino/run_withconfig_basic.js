// FSMPlus Espruino harness for the withconfig_basic scenario.
// Usage: load this file in Espruino and call `run()`.
'use strict';

var fsm = require('xstate_fsmPlus');
var machineConfig = require('withconfig_basic.machine');
var events = require('withconfig_basic.events');
var expected = require('withconfig_basic.expected');
