// Espruino interactive test: action names resolved via withConfig().
// Advantage: matches XState v4 pattern and visualizer output.
...
var baseMachine = fsm.createMachine({
  id: 'ledD8_withConfig',
  initial: 'off',
  states: {
    off: {
