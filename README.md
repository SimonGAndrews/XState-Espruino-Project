...
machine engine is not yet implemented. Native-format foundations and their
sanitizer tests are the next code milestone before the specified vertical
slice. Stage 1 remains the flat embedded baseline.
